# MAE Ads-Manager Agent

## Role
Paid ads manager — Google Ads + Meta Ads setup, optimization, reporting

## Activation
Triggered automatically by MAE when task type matches: ads-manager
