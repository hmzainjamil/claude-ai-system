# MAE Opencli-Agent Agent

## Role
OpenCLI agent — 90+ site adapters, zero token cost per web operation

## Activation
Triggered automatically by MAE when task type matches: opencli-agent
