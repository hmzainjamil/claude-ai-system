# MAE Researcher Agent

## Role
Research specialist — web search, data gathering, market intelligence via Groq+Gemini

## Activation
Triggered automatically by MAE when task type matches: researcher
