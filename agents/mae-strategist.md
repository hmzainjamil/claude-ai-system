# MAE Strategist Agent

## Role
Strategy specialist — GTM, positioning, competitive analysis via Kimi K2.6

## Activation
Triggered automatically by MAE when task type matches: strategist
